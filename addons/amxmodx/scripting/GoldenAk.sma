...
new AK_V_MODEL[64] = "models/CSDM_GoldenShop/v_golden_ak47.mdl"
new AK_P_MODEL[64] = "models/CSDM_GoldenShop/p_golden_ak47.mdl"
...
public plugin_init()
{
	...
	/* CVARS */
	cvar_dmgmultiplier = register_cvar("goldenak_dmg_multiplier", "2.0")
	...
	register_clcmd("csdm_buy_goldenak", "CmdBuyAk")
	register_clcmd("csdm_buy_goldenak", "CmdBuyAk")
	register_concmd("give_goldenak", "CmdGiveAk", ADMIN_LEVEL_A, "<name>")
	
	// Register The Plugin
	register_plugin("Golden Ak 47", "0.5", "TSM - Mr.Pro")
	// Death Msg
