...
public plugin_init( )
{
	...
	g_pCvarSQLHost      = register_cvar( "amx_gag_sql_host",      "127.0.0.1"      );
	g_pCvarSQLUser      = register_cvar( "amx_gag_sql_user",      "root"      );
	g_pCvarSQLPass      = register_cvar( "amx_gag_sql_pass",      ""      );
	g_pCvarSQLDb        = register_cvar( "amx_gag_sql_db",        "amx"      );
