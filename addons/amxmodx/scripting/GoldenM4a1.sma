...
new M4_V_MODEL[64] = "models/CSDM_GoldenShop/v_golden_m4a1.mdl"
new M4_P_MODEL[64] = "models/CSDM_GoldenShop/p_golden_m4a1.mdl"
...
public plugin_init()
{
	...
	/* CVARS */
	cvar_dmgmultiplier = register_cvar("goldenm4_dmg_multiplier", "2.0")
	...
	register_concmd("amx_goldenm4", "CmdGiveM4", ADMIN_LEVEL_A, "<name>")
	register_clcmd("csdm_goldenshop_goldenm4", "CmdBuyM4")
	register_clcmd("csdm_goldenshop_goldenm4", "CmdBuyM4")
	
	// Register The Plugin
	register_plugin("Golden M4A1", "1.0", "cSPlugins")
	// Death Msg
