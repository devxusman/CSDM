...
public plugin_init()
{
	register_plugin("CSHOP Addon: Admin Discount", PLUGIN_VERSION, "OciXCrom")
	g_pFlag = register_cvar("cshop_discount_flag", "d")
	g_pDiscount = register_cvar("cshop_discount_amount", "-30%")
}
